  ...
  class BotStitch {
    ...
    open() {
      if (this.chatElement) {
        ...
        // Show starter prompts once per session if configured
    ...
    showStarterPrompts() {
      ...
      // Avoid duplicates if container already exists
      ...
      this.config.theme.chatWindow.starterPrompts.forEach(prompt => {
        if (prompt) {
          ...
          button.addEventListener('click', () => {
            ...
            // Keep flag true to prevent re-adding prompts
            this.starterPromptsDisplayed = true;
          });
      ...
      // Mark as displayed after initial render
      this.starterPromptsDisplayed = true;
    }
